...
public class ItemServlet extends HttpServlet {
    ...
    /**
     * Handle GET requests - display item pages
     */
    @Override
    ...
    /**
     * Handle POST requests - process item operations
     */
    @Override
    ...
    private void addItem(HttpServletRequest request, HttpServletResponse response)
        ...
        if (itemId == null || itemName == null || priceStr == null || stockStr == null ||
            ...
            preserveFormData(request, itemId, itemName, priceStr, stockStr);
            showAddItemForm(request, response);
            return;
        }
    ...
    private void preserveFormData(HttpServletRequest request, String itemId,
                                  String itemName, String price, String stock) {
